...
public class StudentSystem {
    public static void main(String[] args) {
        ...
        Student s1 = new LibraryStudent("Lokeshwar", 23, 7.0, 3);
        Student s2 = new SportsStudent("Chandu", 24, 8.1, "Cricket");
        Student s3 = new LibraryStudent("Sathi", 23, 6.8, 5);
        Student s4 = new SportsStudent("Sai Kiran", 22, 8.9, "Shuttle");
        ...
        manager.showStudentsByGradeRange(7.0, 8.5);
    }
}